        ...
        <section>
            ...
            <div class="sectionBox02">
                ...
                <div class="searchContainer02">
                        ...
                        <div class="addBox">
                            <div class="addinnerBox">
                                <div class="addTextBox">
                                    <%-- <div>
                                        <input type="text" name="addText" class="inputText" id="addText01" maxlength="20">
                                    </div>
                                    <div>
                                        <div>
                                            <button class="textAddBtn" id="plusButton01">+</button>
                                        </div>
                                    </div> --%>
                                    <table class="inputTable" id="inputTable">
                                        <tr><td><input type="text" name="addText" class="inputText" id="addText" maxlength="20"></td><td><button class="textAddBtn" id="plusButton">+</button></td></tr>
                                    </table>
                                </div>
                    ...
                    <div class="btnBox">
                        <div><button class="colorBtn color1"></button></div>
                        <div><button class="colorBtn color2"></button></div>
                        <div><button class="colorBtn color3"></button></div>
                        <div><button class="colorBtn color4"></button></div>
                        <div><button class="colorBtn color5"></button></div>
...
<hr>
    ...
    <script src="/resources/js/equipmentControl/scenario/add/add_save25_3.js"></script>
</body>
</html>