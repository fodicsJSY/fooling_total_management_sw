                ...
                <div class="searchContainer01">
                    <div class="titleContiner01">
                        <div class="titleBox">
                            ...
                            <div class="typeBox">
                                <div class="searchType"><a href="/" class="rainfall"># 일간강우</a></div>
                                <div class="searchType"><a href="/"class="rainfall"># 월간강우</a></div>
                                <div class="searchType"><a href="/"class="rainfall"># 연간강우</a></div>
                                <div class="searchType"><a href="/"class="rainfall"># 기간별강우</a></div>
                            </div>
                        </div>
                    </div>
