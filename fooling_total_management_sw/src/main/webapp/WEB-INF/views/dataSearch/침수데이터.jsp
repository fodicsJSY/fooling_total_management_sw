...
<head>
    ...
    <title>inundationData</title>

    <link rel="stylesheet" href="/resources/css/dataSearch/침수데이터.css">
</head>
<body>
    <header>
        ...
        <section>
            <div class="sectionBox01">
                <div class="listBox">
                    ...
                    <div class="listContent"><a href="#" class="pageFoward nowForward">침수 데이터</a></div>
    ...
    <script></script>
    <script src="resources/js/dataSearch/침수데이터.js"></script>
