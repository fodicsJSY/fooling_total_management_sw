...
<head>
    ...
    <title>입출차정보</title>
        ...
        <link rel="stylesheet" href="/resources/css/dataSearch/입출차정보.css">
</head>
<body>
    <header>
        ...
        <section>
            <div class="sectionBox01">
                <div class="listBox">
                    ...
                    <div class="listContent"><a href="#" class="pageFoward nowForward">입출차 정보</a></div>
                </div>
            </div>
                ...
                <div class="searchContainer01">
                    <div class="titleContiner01">
                        <div class="titleBox">
                            ...
                            <div class="typeBox">
                                <div class="searchType"><button type="button" class="rainfall active" id="dayRainfall"># 일간</button></div>
    ...
    <script></script>
    <script src="resources/js/dataSearch/입출차정보.js"></script>
